<template><h1 id="分布式事务" tabindex="-1"><a class="header-anchor" href="#分布式事务" aria-hidden="true">#</a> 分布式事务</h1>
<h2 id="分布式一致性" tabindex="-1"><a class="header-anchor" href="#分布式一致性" aria-hidden="true">#</a> 分布式一致性</h2>
...
<h2 id="分布式事务-1" tabindex="-1"><a class="header-anchor" href="#分布式事务-1" aria-hidden="true">#</a> 分布式事务</h2>
<blockquote>
...
<h2 id="xa-规范" tabindex="-1"><a class="header-anchor" href="#xa-规范" aria-hidden="true">#</a> XA 规范</h2>
...
<h2 id="_2pc" tabindex="-1"><a class="header-anchor" href="#_2pc" aria-hidden="true">#</a> 2PC</h2>
<blockquote>
...
<h3 id="准备阶段" tabindex="-1"><a class="header-anchor" href="#准备阶段" aria-hidden="true">#</a> 准备阶段</h3>
...
<h3 id="提交阶段" tabindex="-1"><a class="header-anchor" href="#提交阶段" aria-hidden="true">#</a> 提交阶段</h3>
...
<p><img src="https://www.funtl.com/assets/success.png" alt="img"></p>
<ol>
...
<p><img src="https://www.funtl.com/assets/fail.png" alt="img"></p>
<ol>
...
<h2 id="_3pc" tabindex="-1"><a class="header-anchor" href="#_3pc" aria-hidden="true">#</a> 3PC</h2>
<blockquote>
<p>三阶段提交（Three-phase commit），也叫三阶段提交协议（Three-phase commit protocol），是二阶段提交（2PC）的改进版本。</p>
</blockquote>
<p><img src="https://www.funtl.com/assets/3pccommit.png" alt="img"></p>
<p>与两阶段提交不同的是，三阶段提交有两个改动点。</p>
<ol>
<li>引入超时机制。同时在协调者和参与者中都引入超时机制。</li>
<li>在第一阶段和第二阶段中插入一个准备阶段。保证了在最后提交阶段之前各参与节点的状态是一致的。</li>
</ol>
<p>也就是说，除了引入超时机制之外，3PC 把 2PC 的准备阶段再次一分为二，这样三阶段提交就有 <code v-pre>CanCommit</code>、<code v-pre>PreCommit</code>、<code v-pre>DoCommit</code> 三个阶段。</p>
<h3 id="cancommit-阶段" tabindex="-1"><a class="header-anchor" href="#cancommit-阶段" aria-hidden="true">#</a> CanCommit 阶段</h3>
...
<h3 id="precommit-阶段" tabindex="-1"><a class="header-anchor" href="#precommit-阶段" aria-hidden="true">#</a> PreCommit 阶段</h3>
...
<h3 id="docommit-阶段" tabindex="-1"><a class="header-anchor" href="#docommit-阶段" aria-hidden="true">#</a> doCommit 阶段</h3>
...
<blockquote>
<p>在 <code v-pre>doCommit</code> 阶段，如果参与者无法及时接收到来自协调者的 <code v-pre>doCommit</code> 或者 <code v-pre>abort</code> 请求时，会在等待超时之后，会继续进行事务的提交。（其实这个应该是基于概率来决定的，当进入第三阶段时，说明参与者在第二阶段已经收到了 <code v-pre>PreCommit</code> 请求，那么协调者产生 <code v-pre>PreCommit</code> 请求的前提条件是他在第二阶段开始之前，收到所有参与者的 <code v-pre>CanCommit</code> 响应都是 <code v-pre>Yes</code>。（一旦参与者收到了 <code v-pre>PreCommit</code>，意味他知道大家其实都同意修改了）所以，一句话概括就是，当进入第三阶段时，由于网络超时等原因，虽然参与者没有收到 <code v-pre>commit</code> 或者 <code v-pre>abort</code> 响应，但是他有理由相信：成功提交的几率很大。）</p>
</blockquote>
<h2 id="_2pc-与-3pc-的区别" tabindex="-1"><a class="header-anchor" href="#_2pc-与-3pc-的区别" aria-hidden="true">#</a> 2PC 与 3PC 的区别</h2>
