<template><h1 id="集群与负载均衡的算法与实现" tabindex="-1"><a class="header-anchor" href="#集群与负载均衡的算法与实现" aria-hidden="true">#</a> 集群与负载均衡的算法与实现</h1>
...
<p><img src="@source/面试宝典/05.分布式/img/e58ab31f70ef56e074051ed24fa4e56ec19decce.png" alt="img"></p>
...
<p><img src="@source/面试宝典/05.分布式/img/fc98cdbdb5e1c6f3f2bba08642b14aa5b95191cb.png" alt="img"></p>
...
<h2 id="lvs" tabindex="-1"><a class="header-anchor" href="#lvs" aria-hidden="true">#</a> LVS</h2>
<h3 id="lvs-支持的三种模式" tabindex="-1"><a class="header-anchor" href="#lvs-支持的三种模式" aria-hidden="true">#</a> LVS 支持的三种模式</h3>
<p><img src="@source/面试宝典/05.分布式/img/bc742829577c79b6040b743e07d176e8d815e512.png" alt="img"></p>
<p>早期 LVS 支持三种模式，<strong>DR 模式</strong>、<strong>TUN 模式</strong>和 <strong>NAT 模式</strong>。</p>
<h4 id="dr-模式" tabindex="-1"><a class="header-anchor" href="#dr-模式" aria-hidden="true">#</a> DR 模式</h4>
...
<h4 id="tun-模式" tabindex="-1"><a class="header-anchor" href="#tun-模式" aria-hidden="true">#</a> TUN 模式</h4>
...
<h4 id="nat-模式" tabindex="-1"><a class="header-anchor" href="#nat-模式" aria-hidden="true">#</a> NAT 模式</h4>
...
<h3 id="lvs-基于-netfilter-框架实现" tabindex="-1"><a class="header-anchor" href="#lvs-基于-netfilter-框架实现" aria-hidden="true">#</a> LVS 基于 NetFilter 框架实现</h3>
<p><img src="@source/面试宝典/05.分布式/img/43e30887518af02f3c95557141b905fabeec779f.png" alt="img"></p>
...
<h3 id="lvs-的改进" tabindex="-1"><a class="header-anchor" href="#lvs-的改进" aria-hidden="true">#</a> LVS 的改进</h3>
<p><img src="@source/面试宝典/05.分布式/img/f2111dd6c11e8dd6ffb32a4a2156361d461e0ebf.png" alt="img"></p>
...
<p><img src="@source/面试宝典/05.分布式/img/b8d1657ff0cfc1ff091443c345a3a7da1f602150.png" alt="img"></p>
...
<p><img src="@source/面试宝典/05.分布式/img/77941914a0f64ecc7fee32dd248a2df6bac00309.png" alt="img"></p>
...
<h2 id="tengine" tabindex="-1"><a class="header-anchor" href="#tengine" aria-hidden="true">#</a> Tengine</h2>
<p><img src="@source/面试宝典/05.分布式/img/db1900a027c4c7f66e2560edfaa56ec69437d942.png" alt="img"></p>
