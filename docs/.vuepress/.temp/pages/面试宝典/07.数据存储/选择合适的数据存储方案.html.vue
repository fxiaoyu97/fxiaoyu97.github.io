<template><h1 id="选择合适的数据存储方案" tabindex="-1"><a class="header-anchor" href="#选择合适的数据存储方案" aria-hidden="true">#</a> 选择合适的数据存储方案</h1>
<h2 id="关系型数据库-mysql" tabindex="-1"><a class="header-anchor" href="#关系型数据库-mysql" aria-hidden="true">#</a> 关系型数据库 MySQL</h2>
...
<h2 id="内存数据库-redis" tabindex="-1"><a class="header-anchor" href="#内存数据库-redis" aria-hidden="true">#</a> 内存数据库 Redis</h2>
...
<h2 id="文档数据库-mongodb" tabindex="-1"><a class="header-anchor" href="#文档数据库-mongodb" aria-hidden="true">#</a> 文档数据库 MongoDB</h2>
...
<h2 id="列族数据库-hbase" tabindex="-1"><a class="header-anchor" href="#列族数据库-hbase" aria-hidden="true">#</a> 列族数据库 HBase</h2>
...
<h2 id="全文搜索引擎-elasticsearch" tabindex="-1"><a class="header-anchor" href="#全文搜索引擎-elasticsearch" aria-hidden="true">#</a> 全文搜索引擎 ElasticSearch</h2>
