<template><h1 id="说说分库与分表设计" tabindex="-1"><a class="header-anchor" href="#说说分库与分表设计" aria-hidden="true">#</a> 说说分库与分表设计</h1>
<h2 id="垂直分表" tabindex="-1"><a class="header-anchor" href="#垂直分表" aria-hidden="true">#</a> 垂直分表</h2>
...
<h2 id="垂直分库" tabindex="-1"><a class="header-anchor" href="#垂直分库" aria-hidden="true">#</a> 垂直分库</h2>
...
<h2 id="水平分表" tabindex="-1"><a class="header-anchor" href="#水平分表" aria-hidden="true">#</a> 水平分表</h2>
...
<h2 id="水平分库" tabindex="-1"><a class="header-anchor" href="#水平分库" aria-hidden="true">#</a> 水平分库</h2>
