<template><h1 id="分库与分表带来的分布式困境与应对之策" tabindex="-1"><a class="header-anchor" href="#分库与分表带来的分布式困境与应对之策" aria-hidden="true">#</a> 分库与分表带来的分布式困境与应对之策</h1>
<h2 id="数据迁移与扩容问题" tabindex="-1"><a class="header-anchor" href="#数据迁移与扩容问题" aria-hidden="true">#</a> 数据迁移与扩容问题</h2>
...
<h2 id="表关联问题" tabindex="-1"><a class="header-anchor" href="#表关联问题" aria-hidden="true">#</a> 表关联问题</h2>
<p>在单库单表的情况下，联合查询是非常容易的。但是，随着分库与分表的演变，联合查询就遇到跨库关联和跨表关系问题。在设计之初就应该尽量避免联合查询，可以通过程序中进行拼装，或者通过反范式化设计进行规避。</p>
<h2 id="分页与排序问题" tabindex="-1"><a class="header-anchor" href="#分页与排序问题" aria-hidden="true">#</a> 分页与排序问题</h2>
...
<h2 id="分布式全局唯一id" tabindex="-1"><a class="header-anchor" href="#分布式全局唯一id" aria-hidden="true">#</a> 分布式全局唯一ID</h2>
