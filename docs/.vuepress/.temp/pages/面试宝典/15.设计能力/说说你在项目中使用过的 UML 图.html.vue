<template><h1 id="说说你在项目中使用过的-uml-图" tabindex="-1"><a class="header-anchor" href="#说说你在项目中使用过的-uml-图" aria-hidden="true">#</a> 说说你在项目中使用过的 UML 图</h1>
...
<h2 id="a-vs-d" tabindex="-1"><a class="header-anchor" href="#a-vs-d" aria-hidden="true">#</a> A vs D</h2>
...
<h2 id="领域类图-vs-实现类图" tabindex="-1"><a class="header-anchor" href="#领域类图-vs-实现类图" aria-hidden="true">#</a> 领域类图 vs 实现类图</h2>
...
<p><img src="@source/面试宝典/15.设计能力/img/1004000.jpeg" alt="img"></p>
<p>这是一个选课系统的简单领域分析类图。可以看到，主要实体有教师、学生、课程和开课安排。每个实体标注了其在业务上具有的属性和方法。而且图中还标明了实体间的关系。</p>
<p>但是，最终系统中可能没有一个学生类和其对应。因为最终系统中有哪些类、各个类有什么属性、方法依赖于所选择的平台和架构。例如，如果使用了 Struts2，则会存在很多 Action 类，而使用了 <a href="https://www.funtl.com/zh/interview/ASP.NET" target="_blank" rel="noopener noreferrer">ASP.NET<ExternalLinkIcon/></a> MVC，则会有很多 Controller 类等，所以，领域类图只于业务有关，和具体实现及编码等计算机技术无关。</p>
