<template><h1 id="你如何进行领域建模" tabindex="-1"><a class="header-anchor" href="#你如何进行领域建模" aria-hidden="true">#</a> 你如何进行领域建模</h1>
<h2 id="运用四色建模法进行领域分析" tabindex="-1"><a class="header-anchor" href="#运用四色建模法进行领域分析" aria-hidden="true">#</a> 运用四色建模法进行领域分析</h2>
...
<h2 id="四色建模法" tabindex="-1"><a class="header-anchor" href="#四色建模法" aria-hidden="true">#</a> 四色建模法</h2>
