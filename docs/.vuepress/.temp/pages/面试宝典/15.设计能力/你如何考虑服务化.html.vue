<template><h1 id="你如何考虑服务化" tabindex="-1"><a class="header-anchor" href="#你如何考虑服务化" aria-hidden="true">#</a> 你如何考虑服务化</h1>
<h2 id="集中式与分布式" tabindex="-1"><a class="header-anchor" href="#集中式与分布式" aria-hidden="true">#</a> 集中式与分布式</h2>
<p>要谈微服务，那么必须建立在分布式的基础上，对于一个集中式系统也无需谈微服务。</p>
<p><img src="@source/面试宝典/15.设计能力/img/fenbu.jpeg" alt="img"></p>
<h3 id="集中式" tabindex="-1"><a class="header-anchor" href="#集中式" aria-hidden="true">#</a> 集中式</h3>
...
<p>拿电商网站来说，我们一般把一个电商网站横向拆分成商品模块、订单模块、购物车模块、消息模块、支付模块等。然后我们把不同的模块部署到不同的机器上，各个模块之间通过远程服务调用(<code v-pre>RPC</code>)等方式进行通信。以一个分布式的系统对外提供服务。</p>
<h2 id="服务化" tabindex="-1"><a class="header-anchor" href="#服务化" aria-hidden="true">#</a> 服务化</h2>
...
<p><img src="@source/面试宝典/15.设计能力/img/RPC.jpeg" alt="img"></p>
<h2 id="面向服务的架构" tabindex="-1"><a class="header-anchor" href="#面向服务的架构" aria-hidden="true">#</a> 面向服务的架构</h2>
<p>面向服务架构（Service-Oriented Architecture，<code v-pre>SOA</code>）又称“面向服务的体系结构”，是Gartner于2O世纪9O年代中期提出的面向服务架构的概念。</p>
<blockquote>
<p>面向服务架构，从语义上说，它与面向过程、面向对象、面向组件一样，是一种软件组建及开发的方式。与以往的软件开发、架构模式一样，SOA 只是一种体系、一种思想，而不是某种具体的软件产品。</p>
</blockquote>
<p><img src="@source/面试宝典/15.设计能力/img/SOA.jpeg" alt="img"></p>
<p>这里，我们通过一个例子来解释一下到底什么是 SOA？如何做到 SOA？</p>
<h3 id="什么是-soa" tabindex="-1"><a class="header-anchor" href="#什么是-soa" aria-hidden="true">#</a> 什么是 SOA</h3>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>public interface Echo {
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>上面这段代码相信有过 JavaWeb 开发经验的人都不会陌生。就是定义了一个服务的接口和实现。</p>
...
<h3 id="实现-soa" tabindex="-1"><a class="header-anchor" href="#实现-soa" aria-hidden="true">#</a> 实现 SOA</h3>
<p>修改一下上面的 Echo，添加 Java EE 的 <code v-pre>@WebServices</code> 注解</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>@WebServices
public class EchoImpl implements Echo {
    public String echo(String text) {
        return text;
    }
}
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>现在将 Echo 发布为 Java WebServices，并由底层框架自动生成 WSDL 来作为标准化的服务契约，这样就能与远程的各种语言和平台互操作了，较好的解决了上面提到的松耦合和可重用的问题。按照一般的理解，Echo 似乎就成为比较理想的 SOA service了。</p>
...
<h2 id="面向对象和面向服务的对比" tabindex="-1"><a class="header-anchor" href="#面向对象和面向服务的对比" aria-hidden="true">#</a> 面向对象和面向服务的对比</h2>
<p>面向对象（<code v-pre>OO</code>）和面向服务（<code v-pre>SO</code>）在基础理念上有大量共通之处，比如都尽可能追求抽象、封装和低耦合。</p>
...
<h2 id="微服务架构" tabindex="-1"><a class="header-anchor" href="#微服务架构" aria-hidden="true">#</a> 微服务架构</h2>
<p>微服务架构(<code v-pre>MicroService</code>)是一种服务化架构风格，通过将功能分散到各个离散的服务中以实现对解决方案的解耦。微服务架构强调的第一个重点就是业务系统需要彻底的组件化和服务化（这也是我们为什么要先介绍组件化和服务化的原因）。微服务的诞生并非偶然。它是互联网高速发展，敏捷、精益、持续交付方法论的深入人心，虚拟化技术与 DevOps 文化的快速发展以及传统单块架构无法适应快速变化等多重因素的推动下所诞生的产物。</p>
...
<h2 id="soa-和微服务" tabindex="-1"><a class="header-anchor" href="#soa-和微服务" aria-hidden="true">#</a> SOA 和微服务</h2>
