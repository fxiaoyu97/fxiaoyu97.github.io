<template><h1 id="你如何划分领域边界" tabindex="-1"><a class="header-anchor" href="#你如何划分领域边界" aria-hidden="true">#</a> 你如何划分领域边界</h1>
<h2 id="【领域驱动设计】浅谈聚合的划分与设计" tabindex="-1"><a class="header-anchor" href="#【领域驱动设计】浅谈聚合的划分与设计" aria-hidden="true">#</a> 【领域驱动设计】浅谈聚合的划分与设计</h2>
...
<h2 id="聚合划分与设计其实与并发和事务性并不矛盾" tabindex="-1"><a class="header-anchor" href="#聚合划分与设计其实与并发和事务性并不矛盾" aria-hidden="true">#</a> 聚合划分与设计其实与并发和事务性并不矛盾</h2>
...
<h2 id="两个例子-销售订单-sales-order-订单明细-sales-line-vs-论坛主题-post-回复-reply" tabindex="-1"><a class="header-anchor" href="#两个例子-销售订单-sales-order-订单明细-sales-line-vs-论坛主题-post-回复-reply" aria-hidden="true">#</a> 两个例子：销售订单（Sales Order）/订单明细（Sales Line） vs. 论坛主题（Post）/回复（Reply）</h2>
...
<p><img src="@source/面试宝典/15.设计能力/img/201112241000166739.png" alt="img"></p>
...
<p><img src="@source/面试宝典/15.设计能力/img/201112241000175966.png" alt="img"></p>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>public IEnumerable&lt;ReplyDataObject> GetRepliesForPost(Guid postId)
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>这部分内容牵涉到了应用层，或许你会觉得，这样做是不是把业务逻辑迁移到了应用层，导致领域模型失血。其实不然，在这里，应用层并没有参与任何业务逻辑，从仓储读取领域对象以及将领域对象转换成数据传输对象（DTO），这些并不属于业务逻辑的范畴：因为从领域模型和业务逻辑的角度看，它们并不能知道什么是仓储、什么是规约、什么是数据传输对象。应用层在这里起到了任务协调、数据转换等作用。不仅如此，应用层甚至还可以包含业务规则引擎以及工作流的实现（workflow）。</p>
</template>
