<template><h1 id="你如何对需求原型进行理解和拆分" tabindex="-1"><a class="header-anchor" href="#你如何对需求原型进行理解和拆分" aria-hidden="true">#</a> 你如何对需求原型进行理解和拆分</h1>
...
<p>在一家小型的创业公司，从项目的需求——项目的落实——项目的上线，他们大致会走这样的流程：<code v-pre>产品策划</code> – <code v-pre>UI设计</code> – <code v-pre>研发评审</code> – <code v-pre>测试评审</code> – <code v-pre>研发阶段</code> – <code v-pre>测试阶段</code> – <code v-pre>上线</code>。结合那个面试题，详细的讲述产品策划这块，简要的描述一下后续几个流程。</p>
<p><img src="@source/面试宝典/14.需求分析/img/f7lRMoelw72Xzm1JGXtA.png" alt="img"></p>
<p>根据以上笔试题，我们可以得知：卡牛-信用卡管家 APP 的用户反馈得知，用户希望在卡牛 APP 有一个可以寻找 附近银行网点／ATM的功能。</p>
<h2 id="产品策划" tabindex="-1"><a class="header-anchor" href="#产品策划" aria-hidden="true">#</a> 产品策划</h2>
...
<p><img src="@source/面试宝典/14.需求分析/img/nEr2nG1D50mXOrfwUUM8.png" alt="img"></p>
...
<h3 id="产品功能调研" tabindex="-1"><a class="header-anchor" href="#产品功能调研" aria-hidden="true">#</a> 产品功能调研</h3>
<ol>
...
<h3 id="绘制流程图和原型图" tabindex="-1"><a class="header-anchor" href="#绘制流程图和原型图" aria-hidden="true">#</a> 绘制流程图和原型图</h3>
...
<p><img src="@source/面试宝典/14.需求分析/img/ONXZIubgzBvcy84Xx4ed.png" alt="img"></p>
<h4 id="主流程图——附近" tabindex="-1"><a class="header-anchor" href="#主流程图——附近" aria-hidden="true">#</a> 主流程图——附近</h4>
<p><img src="@source/面试宝典/14.需求分析/img/QjCZNjWkPmo1kJh4ilC8.png" alt="img"></p>
<h4 id="流程图——评价" tabindex="-1"><a class="header-anchor" href="#流程图——评价" aria-hidden="true">#</a> 流程图——评价</h4>
<p><img src="@source/面试宝典/14.需求分析/img/z6gJbfOvbGobGWS8TAb5.png" alt="img"></p>
<h4 id="流程图——预约" tabindex="-1"><a class="header-anchor" href="#流程图——预约" aria-hidden="true">#</a> 流程图——预约</h4>
<p><img src="@source/面试宝典/14.需求分析/img/6kbBXwoXLkuzcCnodwrL.png" alt="img"></p>
<h3 id="原型交互" tabindex="-1"><a class="header-anchor" href="#原型交互" aria-hidden="true">#</a> 原型交互</h3>
<p>在原型交互的过程中，有些公司需要你在产品原型图上做动态交互，有些公司只需要你在产品原型图上做好交互标明。对此评价一下没做交互动态和做了交互动态的优缺点。</p>
<p><img src="@source/面试宝典/14.需求分析/img/KVQx3NfESBUeBz4EzHr5.jpeg" alt="img"></p>
<h4 id="整体原型图" tabindex="-1"><a class="header-anchor" href="#整体原型图" aria-hidden="true">#</a> 整体原型图</h4>
<p><img src="@source/面试宝典/14.需求分析/img/Il1UYXXpYvxzH6lAlabI.png" alt="img"></p>
<h4 id="交互原型图" tabindex="-1"><a class="header-anchor" href="#交互原型图" aria-hidden="true">#</a> 交互原型图</h4>
<p><img src="@source/面试宝典/14.需求分析/img/NNOPJZI0E53bdkhe9gGG.png" alt="img"></p>
<p><img src="@source/面试宝典/14.需求分析/img/TBUwHwDcwQZzJGcdgcM9.png" alt="img"></p>
<p><img src="@source/面试宝典/14.需求分析/img/rTWtwz6hiWhpUyGJN4eI.png" alt="img"></p>
<h3 id="搜集产品部门内部意见" tabindex="-1"><a class="header-anchor" href="#搜集产品部门内部意见" aria-hidden="true">#</a> 搜集产品部门内部意见</h3>
...
<h2 id="ui设计" tabindex="-1"><a class="header-anchor" href="#ui设计" aria-hidden="true">#</a> UI设计</h2>
...
<h2 id="研发评审" tabindex="-1"><a class="header-anchor" href="#研发评审" aria-hidden="true">#</a> 研发评审</h2>
...
<h2 id="测试评审" tabindex="-1"><a class="header-anchor" href="#测试评审" aria-hidden="true">#</a> 测试评审</h2>
...
<h2 id="研发阶段" tabindex="-1"><a class="header-anchor" href="#研发阶段" aria-hidden="true">#</a> 研发阶段</h2>
...
<h2 id="上线" tabindex="-1"><a class="header-anchor" href="#上线" aria-hidden="true">#</a> 上线</h2>
