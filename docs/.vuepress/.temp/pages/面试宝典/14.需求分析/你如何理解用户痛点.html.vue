<template><h1 id="你如何理解用户痛点" tabindex="-1"><a class="header-anchor" href="#你如何理解用户痛点" aria-hidden="true">#</a> 你如何理解用户痛点</h1>
<h2 id="什么是用户-痛点" tabindex="-1"><a class="header-anchor" href="#什么是用户-痛点" aria-hidden="true">#</a> 什么是用户“痛点”</h2>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819154634.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819154645.jpeg" alt="img"></p>
<p>上面应该是一个正常用户使用图像处理软件的全部过程：先下载，然后学会怎么用，然后使用它做图片。</p>
<p><strong>然后，你需要找出在每个阶段，影响用户行为的关键因素有哪些？</strong></p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819154656.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819154835.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819154845.jpeg" alt="img"></p>
...
<h2 id="纵向寻找" tabindex="-1"><a class="header-anchor" href="#纵向寻找" aria-hidden="true">#</a> 纵向寻找</h2>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819154856.jpeg" alt="img"></p>
<p>最终，他们研发出了这种“笔形”的胰岛素，不容易被识别，帮患者遮盖了“糖尿病人”的形象，同时不需要用针注射，提高了使用的容易程度。</p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819154906.jpeg" alt="img"></p>
<p>所以，纵向寻找痛点，你需要先找出影响某个环节的全部因素，然后看哪个因素是消费者现在的最大阻碍。</p>
<h2 id="横向寻找" tabindex="-1"><a class="header-anchor" href="#横向寻找" aria-hidden="true">#</a> 横向寻找</h2>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819154948.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155001.jpeg" alt="img"></p>
<p><strong>不光可以用于寻找产品痛点，还可以用于文案痛点</strong></p>
<p>比如肯德基搞过一个在线优惠活动，文案如下：</p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155026.jpeg" alt="img"></p>
<p>如何分析这个广告呢？</p>
<p><strong>首先我们先列出消费的行动过程：先看到文案，然后参加活动。</strong></p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155044.jpeg" alt="img"></p>
<p><strong>然后找出每个阶段的主要驱动因素，比如：有兴趣、很容易做到等。</strong></p>
<p>就会发现这个文案的聚焦点在于：提高活动的吸引力，让人产生兴趣（比如足够的优惠）。</p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155055.jpeg" alt="img"></p>
<p><strong>但是如果问：现在限制消费者参加活动的关键因素是什么？</strong></p>
<p>答案应该是：整个过程太复杂，不够容易。</p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155104.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155114.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155122.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155130.jpeg" alt="img"></p>
<p>然后把这个广告产生的所有影响涂成橙色，就会发现是这样的：</p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155139.jpeg" alt="img"></p>
...
<blockquote>
<p>真正的男人不需要海豹鞭 但，如果你没有他们那么强 请联系我们购买：<a href="https://www.funtl.com/zh/interview/XXXX.com" target="_blank" rel="noopener noreferrer">XXXX.com<ExternalLinkIcon/></a></p>
</blockquote>
<p>这也是为什么自杀相关的新闻曝光后，自杀的人会变多。</p>
<p>总之，既然文案是为了改变用户的行为，那么设计文案的时候也要分析：</p>
<p><strong>限制用户改变行为的关键障碍是什么？</strong></p>
<h2 id="改变用户的某个习惯" tabindex="-1"><a class="header-anchor" href="#改变用户的某个习惯" aria-hidden="true">#</a> 改变用户的某个习惯</h2>
<p>除了产品设计、文案设计，其实几乎任何一种涉及改变的活动，都需要分析痛点，找到影响对方的关键障碍。</p>
<p>比如假设你想帮助人戒烟，那么首先列出吸烟的全部过程：</p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155150.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155200.jpeg" alt="img"></p>
<p>找到了这个矩阵，你就会发现过去几乎所有的戒烟干预方式，都聚焦于“吸烟”这个过程，而且是“吸烟”的风险这个过程：</p>
<p>（强调：吸烟有害健康）</p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155212.jpeg" alt="img"></p>
<p>比如这个创意广告：</p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155219.jpeg" alt="img"></p>
<p>而其实可以有效干预的痛点有很多：</p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155228.jpeg" alt="img"></p>
<p>比如降低送烟的形象，想办法让送烟变成一种丢脸的行为。</p>
<p>比如降低吸烟的效用，让大众相信吸烟其实并不会提高注意力，等。</p>
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155236.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/QQ20150819155245.jpeg" alt="img"></p>
