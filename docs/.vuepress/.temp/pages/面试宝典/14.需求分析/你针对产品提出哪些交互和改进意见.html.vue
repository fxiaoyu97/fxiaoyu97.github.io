<template><h1 id="你针对产品提出哪些交互和改进意见" tabindex="-1"><a class="header-anchor" href="#你针对产品提出哪些交互和改进意见" aria-hidden="true">#</a> 你针对产品提出哪些交互和改进意见</h1>
<blockquote>
...
<h2 id="过度追求精准" tabindex="-1"><a class="header-anchor" href="#过度追求精准" aria-hidden="true">#</a> 过度追求精准</h2>
<h3 id="例1-我们都知道载入内容时需要-loading-状态-如下图" tabindex="-1"><a class="header-anchor" href="#例1-我们都知道载入内容时需要-loading-状态-如下图" aria-hidden="true">#</a> 例1：我们都知道载入内容时需要 loading 状态，如下图：</h3>
<p><img src="@source/面试宝典/14.需求分析/img/f0fcd6e5-874f-4894-9e0c-39fb1574c6de.jpeg" alt="img"></p>
<p>现实的业务场景中，需要加载的内容往往不只一个。如下图：虽然图表比较多，但排列整齐有序，所以看上去还是比较舒适的。</p>
<p><img src="@source/面试宝典/14.需求分析/img/6759f77b-6cfb-4b29-9eb7-66252f5e8d27.jpeg" alt="img"></p>
<p>再来看第三张：这样的 loading，是你想要的吗？</p>
<p><img src="@source/面试宝典/14.需求分析/img/780646e1-86ff-4479-999a-01268f83213c.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/88cfa64c-41be-4911-9309-09f5050f63f3.jpeg" alt="img"></p>
<h3 id="例2-这是一个筛选器控件的样式设置页面-有两种样式-纵向、横向" tabindex="-1"><a class="header-anchor" href="#例2-这是一个筛选器控件的样式设置页面-有两种样式-纵向、横向" aria-hidden="true">#</a> 例2：这是一个筛选器控件的样式设置页面，有两种样式：纵向、横向</h3>
<p><img src="@source/面试宝典/14.需求分析/img/a1344109-2ef8-46e7-94b7-c5f619189506.jpeg" alt="img"></p>
<p>纵向的列表筛选器，相信大部分人都能理解。如下图：当你勾选了需要筛选的内容时，相对应的内容就会被展示。</p>
<p><img src="@source/面试宝典/14.需求分析/img/8f0a71ee-44cc-4996-be6b-b36e109d4122.jpeg" alt="img"></p>
<p>好了，现在来想象一下，横向是什么？是这样的：</p>
<p><img src="@source/面试宝典/14.需求分析/img/1c320f4a-e8eb-4f75-9986-4223227b0caf.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/7f4136e0-c0b3-4672-926f-90a64dc4bb9c.jpeg" alt="img"></p>
<p>这非常像一个导航，切换导航就是筛选的过程。最终，我们把设置面板改成了下图：「列表」和「导航」。虽然从含义上不如前者精准，但对用户来说，看到文案能够直观地联想到最终展现形式，体验上会更友好。</p>
<p><img src="@source/面试宝典/14.需求分析/img/d597677f-fdcd-45f8-9241-ef37a443b8df.jpeg" alt="img"></p>
<h2 id="死板遵循设计法则" tabindex="-1"><a class="header-anchor" href="#死板遵循设计法则" aria-hidden="true">#</a> 死板遵循设计法则</h2>
...
<p><img src="@source/面试宝典/14.需求分析/img/d1a5ebb5-c5d0-4dac-ae00-9d90fa3210eb.jpeg" alt="img"></p>
<p>在另一个界面，也有数据格式的设置，为了遵循操作方式一致，设计成了这样，如图：</p>
<p><img src="@source/面试宝典/14.需求分析/img/dc2d1135-86cf-4315-9d8c-34a5060cd7d0.jpeg" alt="img"></p>
<p>细看后是否觉得有些地方比较违和？虽然都是通过点击操作激活设置弹窗，但表单中的链接一般不会孤零零的出现在某一个条目中。其次，在弹窗中应该尽量避免再出现一层弹窗，所以设置入口放在这里，是不合适的。</p>
<p><img src="@source/面试宝典/14.需求分析/img/065f380e-5446-471c-abda-735d11c53662.jpeg" alt="img"></p>
<p>修改一下，这样看上去是不是顺眼多了？</p>
<p>虽然操作方式没有完全统一，但弹窗和下拉菜单面板中的内容布局是一致的。除此之外，下拉框和上一个表单条目也保持了形式统一，整体更和谐。灵活而不机械的运用设计法则，才能将其作用发挥到最大。</p>
<h2 id="过度假设用户行为" tabindex="-1"><a class="header-anchor" href="#过度假设用户行为" aria-hidden="true">#</a> 过度假设用户行为</h2>
...
<p><img src="@source/面试宝典/14.需求分析/img/56e64473-aa07-42ae-b10d-d17bb6abb6a4.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/d55ba135-b8b6-4478-af61-c154cc3e7a57.jpeg" alt="img"></p>
<p>建议刚开始选择较为简单的方案，同时留出可扩展的空间。如果简单的设计方案已经能满足用户了，就不用盲目做加法。如果根据后期的可用性测试验证用户还有新的需求，再逐步添加。不要一下子就把用户行为想得太复杂，设计太多，吃力还不讨好。</p>
<h2 id="过多展示内在业务逻辑" tabindex="-1"><a class="header-anchor" href="#过多展示内在业务逻辑" aria-hidden="true">#</a> 过多展示内在业务逻辑</h2>
<p>To b 产品往往业务属性较强，内部逻辑比较复杂，概念定义也多。如图：</p>
<p><img src="@source/面试宝典/14.需求分析/img/4e2160f2-0fca-4c40-b402-8912376ccbcd.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/14.需求分析/img/84531c2b-f7a2-4b0f-8310-540fcac304b4.jpeg" alt="img"></p>
<p>把两个概念合二为一，直接进入当前页面设置，如果有需要，再勾选应用到全局，用户不需要在不同的入口之间犹豫选择，体验上会好很多。</p>
<h2 id="过于把用户当「小白」" tabindex="-1"><a class="header-anchor" href="#过于把用户当「小白」" aria-hidden="true">#</a> 过于把用户当「小白」</h2>
...
<p><img src="@source/面试宝典/14.需求分析/img/28155d54-6ff7-4abf-8ead-a209b6b7fab1.jpeg" alt="img"></p>
<p>如果注释框难以解释清楚复杂问题，可以直接提供帮助手册的链接，点击跳转到新页面查看详细说明。</p>
<p><img src="@source/面试宝典/14.需求分析/img/ba2f83ec-27f7-4121-b58f-13be143353a2.jpeg" alt="img"></p>
<p>对于有一定专业基础的用户来说，提供工具书，当他遇到问题时自行查阅，比强制性的手把手教往往作用更大。</p>
<h2 id="盲目满足用户需求" tabindex="-1"><a class="header-anchor" href="#盲目满足用户需求" aria-hidden="true">#</a> 盲目满足用户需求</h2>
