<template><h1 id="面向对象的特征" tabindex="-1"><a class="header-anchor" href="#面向对象的特征" aria-hidden="true">#</a> 面向对象的特征</h1>
...
<p>多态性（polymorphisn）是允许你将父对象设置成为和一个或更多的他的子对象相等的技术，赋值之后，父对象就可以根据当前赋值给它的子对象的特性以不同的方式运作。简单的说，就是一句话：允许将子类类型的指针赋值给父类类型的指针。 实现多态，有二种方式，覆盖，重载。</p>
</template>
