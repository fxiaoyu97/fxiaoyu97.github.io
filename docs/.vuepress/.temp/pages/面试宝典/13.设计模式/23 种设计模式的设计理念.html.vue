<template><h1 id="_23-种设计模式的设计理念" tabindex="-1"><a class="header-anchor" href="#_23-种设计模式的设计理念" aria-hidden="true">#</a> 23 种设计模式的设计理念</h1>
<h2 id="什么是设计模式" tabindex="-1"><a class="header-anchor" href="#什么是设计模式" aria-hidden="true">#</a> 什么是设计模式</h2>
<p>设计模式（Design pattern）是一套被反复使用、多数人知晓的、经过分类编目的、代码设计经验的总结。使用设计模式是为了可重用代码、让代码更容易被他人理解、保证代码可靠性。 毫无疑问，设计模式于己于他人于系统都是多赢的，设计模式使代码编制真正工程化，设计模式是软件工程的基石，如同大厦的一块块砖石一样。项目中合理的运用设计模式可以完美的解决很多问题，每种模式在现在中都有相应的原理来与之对应，每一个模式描述了一个在我们周围不断重复发生的问题，以及该问题的核心解决方案，这也是它能被广泛应用的原因。简单说：</p>
<ul>
...
<h2 id="设计模式的三个分类" tabindex="-1"><a class="header-anchor" href="#设计模式的三个分类" aria-hidden="true">#</a> 设计模式的三个分类</h2>
<ul>
<li>创建型模式：对象实例化的模式，创建型模式用于解耦对象的实例化过程。</li>
<li>结构型模式：把类或对象结合在一起形成一个更大的结构。</li>
<li>行为型模式：类和对象如何交互，及划分责任和算法。</li>
</ul>
<h2 id="各分类中模式的关键点" tabindex="-1"><a class="header-anchor" href="#各分类中模式的关键点" aria-hidden="true">#</a> 各分类中模式的关键点</h2>
