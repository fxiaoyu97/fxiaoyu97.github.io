<template><h1 id="你怎么理解-rpc-框架" tabindex="-1"><a class="header-anchor" href="#你怎么理解-rpc-框架" aria-hidden="true">#</a> 你怎么理解 RPC 框架</h1>
<h2 id="什么是-rpc" tabindex="-1"><a class="header-anchor" href="#什么是-rpc" aria-hidden="true">#</a> 什么是 RPC？</h2>
<p>RPC 是指远程过程调用，也就是说两台服务器 A，B 一个应用部署在 A 服务器上，想要调用 B 服务器上应用提供的函数或方法，由于不在一个内存空间，不能直接调用，需要通过网络来表达调用的语义和传达调用的数据。</p>
<h2 id="rpc-是如何通讯的" tabindex="-1"><a class="header-anchor" href="#rpc-是如何通讯的" aria-hidden="true">#</a> RPC 是如何通讯的？</h2>
<p><img src="@source/面试宝典/06.微服务/img/45366c44f775abfd0ac3b43bccc1abc3_hd.jpeg" alt="img"></p>
<ol>
...
<h2 id="为什么要用-rpc" tabindex="-1"><a class="header-anchor" href="#为什么要用-rpc" aria-hidden="true">#</a> 为什么要用 RPC？</h2>
