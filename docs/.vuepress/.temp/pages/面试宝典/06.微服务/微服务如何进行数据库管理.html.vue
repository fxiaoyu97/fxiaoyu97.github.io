<template><h1 id="微服务如何进行数据库管理" tabindex="-1"><a class="header-anchor" href="#微服务如何进行数据库管理" aria-hidden="true">#</a> 微服务如何进行数据库管理</h1>
<h2 id="分布式数据管理之痛点" tabindex="-1"><a class="header-anchor" href="#分布式数据管理之痛点" aria-hidden="true">#</a> 分布式数据管理之痛点</h2>
...
<p><img src="@source/面试宝典/06.微服务/img/201705272.jpeg" alt="img"></p>
<p>订单服务不能直接访问客户表，只能通过客户服务发布的 API 来访问或者使用分布式事务, 也就是众所周知的两阶段提交 (2PC)来访问客户表，2PC 意义图如下所示：</p>
<p><img src="@source/面试宝典/06.微服务/img/201705273.jpeg" alt="img"></p>
<p>这里存在两个挑战：</p>
<ol>
...
<h2 id="分布式数据管理之举措" tabindex="-1"><a class="header-anchor" href="#分布式数据管理之举措" aria-hidden="true">#</a> 分布式数据管理之举措</h2>
<p>在介绍分布式数据管理(CRUD)解决方案之前，有必要介绍下 CAP 原理和最终一致性相关概念。</p>
<h2 id="cap-原理-cap-theorem" tabindex="-1"><a class="header-anchor" href="#cap-原理-cap-theorem" aria-hidden="true">#</a> CAP 原理(CAP Theorem)</h2>
<p>在足球比赛里，一个球员在一场比赛中进三个球，称之为帽子戏法(Hat-trick)。在分布式数据系统中，也有一个帽子原理(CAP Theorem)，不过此帽子非彼帽子。CAP 原理中，有三个要素：</p>
<ol>
<li>一致性(C onsistency)</li>
<li>可用性(A vailability)</li>
<li>分区容忍性(P artition tolerance)</li>
</ol>
...
<h2 id="最终一致性-eventually-consistent" tabindex="-1"><a class="header-anchor" href="#最终一致性-eventually-consistent" aria-hidden="true">#</a> 最终一致性(eventually consistent)</h2>
...
<h2 id="事件驱动架构简介" tabindex="-1"><a class="header-anchor" href="#事件驱动架构简介" aria-hidden="true">#</a> 事件驱动架构简介</h2>
...
<h3 id="事件驱动示例-1" tabindex="-1"><a class="header-anchor" href="#事件驱动示例-1" aria-hidden="true">#</a> 事件驱动示例 1</h3>
...
<p><img src="@source/面试宝典/06.微服务/img/201705274.jpeg" alt="img"></p>
<ul>
<li>客户服务消费 Order Created Event 事件，为此订单预留信用，发布“Credit Reserved Event(信用预留)”事件。</li>
</ul>
<p><img src="@source/面试宝典/06.微服务/img/201705275.jpeg" alt="img"></p>
<ul>
<li>订单服务消费 Credit Reserved Event，改变订单的状态为 OPEN。</li>
</ul>
<p><img src="@source/面试宝典/06.微服务/img/201705276.jpeg" alt="img"></p>
<h3 id="事件驱动示例-2" tabindex="-1"><a class="header-anchor" href="#事件驱动示例-2" aria-hidden="true">#</a> 事件驱动示例 2</h3>
<p>下图展现如何使用事件驱动方法，在创建订单时触发支付业务的数据更新，微服务之间通过消息代理(Messsage Broker)来交换事件。</p>
<ul>
<li>订单服务创建一个待支付的订单，发布一个“创建订单”的事件。</li>
</ul>
<p><img src="@source/面试宝典/06.微服务/img/201705277.jpeg" alt="img"></p>
<ul>
<li>支付服务消费“创建订单”事件，支付完成后发布一个“支付完成”事件。</li>
</ul>
<p><img src="@source/面试宝典/06.微服务/img/201705278.jpeg" alt="img"></p>
<ul>
<li>订单服务消费“支付完成”事件，订单状态更新为待出库。</li>
</ul>
<p><img src="@source/面试宝典/06.微服务/img/201705279.jpeg" alt="img"></p>
<h2 id="事件驱动架构之分布式数据更新" tabindex="-1"><a class="header-anchor" href="#事件驱动架构之分布式数据更新" aria-hidden="true">#</a> 事件驱动架构之分布式数据更新</h2>
<p>上节通过示例概要介绍了通过事件驱动方式，实现了分布式数据最终一致性保证。纵观微服务架构下的事件驱动业务处理逻辑，其核心要点在于，可靠的事件投递和避免事件的重复消费。</p>
<p>可靠事件投递有以下两个特性：</p>
<ol>
<li>每个服务原子性的完成业务操作和发布事件;</li>
<li>消息代理确保事件投递至少一次(at least once);</li>
</ol>
...
<h3 id="如何实现事件投递操作原子性" tabindex="-1"><a class="header-anchor" href="#如何实现事件投递操作原子性" aria-hidden="true">#</a> 如何实现事件投递操作原子性?</h3>
...
<p><img src="@source/面试宝典/06.微服务/img/2017052710.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/06.微服务/img/2017052711.jpeg" alt="img"></p>
...
<h3 id="如何避免事件重复消费" tabindex="-1"><a class="header-anchor" href="#如何避免事件重复消费" aria-hidden="true">#</a> 如何避免事件重复消费?</h3>
...
<h2 id="事件驱动架构之分布式数据查询" tabindex="-1"><a class="header-anchor" href="#事件驱动架构之分布式数据查询" aria-hidden="true">#</a> 事件驱动架构之分布式数据查询</h2>
...
<h3 id="什么是物化视图-merialized-views" tabindex="-1"><a class="header-anchor" href="#什么是物化视图-merialized-views" aria-hidden="true">#</a> 什么是物化视图(merialized views)?</h3>
...
<h3 id="什么是命令查询职责分离-cqrs" tabindex="-1"><a class="header-anchor" href="#什么是命令查询职责分离-cqrs" aria-hidden="true">#</a> 什么是命令查询职责分离(CQRS)?</h3>
...
<p><img src="@source/面试宝典/06.微服务/img/2017052712.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/06.微服务/img/2017052713.jpeg" alt="img"></p>
...
<h3 id="如何实现事件驱动架构下的数据查询服务" tabindex="-1"><a class="header-anchor" href="#如何实现事件驱动架构下的数据查询服务" aria-hidden="true">#</a> <a href="https://www.funtl.com/zh/interview/Java-%E9%9D%A2%E8%AF%95%E5%AE%9D%E5%85%B8-%E5%BE%AE%E6%9C%8D%E5%8A%A1%E5%A6%82%E4%BD%95%E8%BF%9B%E8%A1%8C%E6%95%B0%E6%8D%AE%E5%BA%93%E7%AE%A1%E7%90%86.html#%E5%A6%82%E4%BD%95%E5%AE%9E%E7%8E%B0%E4%BA%8B%E4%BB%B6%E9%A9%B1%E5%8A%A8%E6%9E%B6%E6%9E%84%E4%B8%8B%E7%9A%84%E6%95%B0%E6%8D%AE%E6%9F%A5%E8%AF%A2%E6%9C%8D%E5%8A%A1" target="_blank" rel="noopener noreferrer">#<ExternalLinkIcon/></a>如何实现事件驱动架构下的数据查询服务?</h3>
...
<p><img src="@source/面试宝典/06.微服务/img/2017052714.jpeg" alt="img"></p>
...
<h2 id="事件驱动架构优缺点" tabindex="-1"><a class="header-anchor" href="#事件驱动架构优缺点" aria-hidden="true">#</a> 事件驱动架构优缺点</h2>
...
<h2 id="重要提醒" tabindex="-1"><a class="header-anchor" href="#重要提醒" aria-hidden="true">#</a> 重要提醒</h2>
