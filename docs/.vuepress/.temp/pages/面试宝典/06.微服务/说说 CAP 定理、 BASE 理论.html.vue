<template><h1 id="说说-cap-定理、-base-理论" tabindex="-1"><a class="header-anchor" href="#说说-cap-定理、-base-理论" aria-hidden="true">#</a> 说说 CAP 定理、 BASE 理论</h1>
<h2 id="cap-定理" tabindex="-1"><a class="header-anchor" href="#cap-定理" aria-hidden="true">#</a> CAP 定理</h2>
...
<h3 id="一致性-consistency" tabindex="-1"><a class="header-anchor" href="#一致性-consistency" aria-hidden="true">#</a> 一致性（Consistency）</h3>
<p>一致性指 “all nodes see the same data at the same time”，即更新操作成功并返回客户端完成后，所有节点在同一时间的数据完全一致。</p>
<h3 id="可用性-availability" tabindex="-1"><a class="header-anchor" href="#可用性-availability" aria-hidden="true">#</a> 可用性（Availability）</h3>
<p>可用性指“Reads and writes always succeed”，即服务一直可用，而且是正常响应时间。</p>
<h3 id="分区容错性-partition-tolerance" tabindex="-1"><a class="header-anchor" href="#分区容错性-partition-tolerance" aria-hidden="true">#</a> 分区容错性（Partition tolerance）</h3>
...
<h2 id="cap-权衡" tabindex="-1"><a class="header-anchor" href="#cap-权衡" aria-hidden="true">#</a> CAP 权衡</h2>
...
<h3 id="基本可用-basically-available" tabindex="-1"><a class="header-anchor" href="#基本可用-basically-available" aria-hidden="true">#</a> 基本可用（Basically Available）</h3>
<p>基本可用是指分布式系统在出现故障的时候，允许损失部分可用性，即保证核心可用。</p>
<p>电商大促时，为了应对访问量激增，部分用户可能会被引导到降级页面，服务层也可能只提供降级服务。这就是损失部分可用性的体现。</p>
<h3 id="软状态-soft-state" tabindex="-1"><a class="header-anchor" href="#软状态-soft-state" aria-hidden="true">#</a> 软状态（Soft State）</h3>
<p>软状态是指允许系统存在中间状态，而该中间状态不会影响系统整体可用性。分布式存储中一般一份数据至少会有三个副本，允许不同节点间副本同步的延时就是软状态的体现。mysql replication 的异步复制也是一种体现。</p>
<h3 id="最终一致性-eventual-consistency" tabindex="-1"><a class="header-anchor" href="#最终一致性-eventual-consistency" aria-hidden="true">#</a> 最终一致性（Eventual Consistency）</h3>
<p>最终一致性是指系统中的所有数据副本经过一定时间后，最终能够达到一致的状态。弱一致性和强一致性相反，最终一致性是弱一致性的一种特殊情况。</p>
<h2 id="acid-和-base-的区别与联系" tabindex="-1"><a class="header-anchor" href="#acid-和-base-的区别与联系" aria-hidden="true">#</a> ACID 和 BASE 的区别与联系</h2>
