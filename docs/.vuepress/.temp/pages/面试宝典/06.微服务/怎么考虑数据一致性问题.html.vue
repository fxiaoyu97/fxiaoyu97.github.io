<template><h1 id="怎么考虑数据一致性问题" tabindex="-1"><a class="header-anchor" href="#怎么考虑数据一致性问题" aria-hidden="true">#</a> 怎么考虑数据一致性问题</h1>
<h2 id="单体应用的数据一致性" tabindex="-1"><a class="header-anchor" href="#单体应用的数据一致性" aria-hidden="true">#</a> 单体应用的数据一致性</h2>
...
<p><img src="@source/面试宝典/06.微服务/img/66ecd4cb674eb4b55f786b7f8517ea07.png" alt="img"></p>
<p>当这个功能上线以后，公司非常满意，客户也非常高兴。</p>
<h2 id="微服务场景下的数据一致性" tabindex="-1"><a class="header-anchor" href="#微服务场景下的数据一致性" aria-hidden="true">#</a> 微服务场景下的数据一致性</h2>
...
<p><img src="@source/面试宝典/06.微服务/img/f1a152a2a4a84d135fafb08525f0f9ce.png" alt="img"></p>
<h2 id="sagas" tabindex="-1"><a class="header-anchor" href="#sagas" aria-hidden="true">#</a> Sagas</h2>
...
<p><img src="@source/面试宝典/06.微服务/img/fc69ade8b2ec344c0d6f53fbec302a37.png" alt="img"></p>
<p>Chris Richardson 在他的文章 Pattern: Saga 中对 Saga 有所描述。 Caitie McCaffrey 也在她的演讲中提到如何在微软的 光晕4 游戏中如何应用 saga 解决数据一致性问题。</p>
<h3 id="saga-的运行原理" tabindex="-1"><a class="header-anchor" href="#saga-的运行原理" aria-hidden="true">#</a> Saga 的运行原理</h3>
<blockquote>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>当每个 saga 子事务 T1, T2, …, Tn 都有对应的补偿定义 C1, C2, …, Cn-1, 那么 saga 系统可以保证

子事务序列 T1, T2, …, Tn 得以完成 (最佳情况)
或者序列 T1, T2, …, Tj, Cj, …, C2, C1, 0 &lt; j &lt; n, 得以完成
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>换句话说，通过上述定义的事务/补偿，saga 保证满足以下业务规则：</p>
<ul>
<li>所有的预订都被执行成功，如果任何一个失败，都会被取消</li>
<li>如果最后一步付款失败，所有预订也将被取消</li>
</ul>
<h3 id="saga-的恢复方式" tabindex="-1"><a class="header-anchor" href="#saga-的恢复方式" aria-hidden="true">#</a> Saga 的恢复方式</h3>
<p>原论文中描述了两种类型的 Saga 恢复方式：</p>
<blockquote>
<p>向后恢复 补偿所有已完成的事务，如果任一子事务失败 向前恢复 重试失败的事务，假设每个子事务最终都会成功</p>
</blockquote>
...
<h3 id="使用-saga-的条件" tabindex="-1"><a class="header-anchor" href="#使用-saga-的条件" aria-hidden="true">#</a> 使用 Saga 的条件</h3>
...
<h3 id="saga-log" tabindex="-1"><a class="header-anchor" href="#saga-log" aria-hidden="true">#</a> Saga Log</h3>
...
<p><img src="@source/面试宝典/06.微服务/img/66ae7b320e502c13f4a21a08baa61ead.png" alt="img"></p>
...
<h3 id="saga-请求的数据结构" tabindex="-1"><a class="header-anchor" href="#saga-请求的数据结构" aria-hidden="true">#</a> Saga 请求的数据结构</h3>
<p>在我们的业务场景下，航班预订、租车、和酒店预订没有依赖关系，可以并行处理，但对于我们的客户来说，只在所有预订成功后一次付费更加友好。那么这四个服务的事务关系可以用下图表示：</p>
<p><img src="@source/面试宝典/06.微服务/img/918b4d0d912c6cdb8ee0690acf303950.png" alt="img"></p>
<p>将行程规划请求的数据结构实现为有向非循环图恰好合适。图的根是 saga 启动任务，叶是 saga 结束任务。</p>
<p><img src="@source/面试宝典/06.微服务/img/c62a633865fd31b25688523cb5f4093f.png" alt="img"></p>
<h3 id="parallel-saga" tabindex="-1"><a class="header-anchor" href="#parallel-saga" aria-hidden="true">#</a> <a href="https://www.funtl.com/zh/interview/Java-%E9%9D%A2%E8%AF%95%E5%AE%9D%E5%85%B8-%E6%80%8E%E4%B9%88%E8%80%83%E8%99%91%E6%95%B0%E6%8D%AE%E4%B8%80%E8%87%B4%E6%80%A7%E9%97%AE%E9%A2%98.html#parallel-saga" target="_blank" rel="noopener noreferrer">#<ExternalLinkIcon/></a>Parallel Saga</h3>
...
<p><img src="@source/面试宝典/06.微服务/img/b683af658000f43b34c7d99d6be060ca.png" alt="img"></p>
...
<h3 id="acid-and-saga" tabindex="-1"><a class="header-anchor" href="#acid-and-saga" aria-hidden="true">#</a> ACID and Saga</h3>
...
<h3 id="saga-架构" tabindex="-1"><a class="header-anchor" href="#saga-架构" aria-hidden="true">#</a> Saga 架构</h3>
<p>最后，我们的 Saga 架构如下：</p>
<p><img src="@source/面试宝典/06.微服务/img/44bd3121a8b6d720704e2d8b363ea2ce.png" alt="img"></p>
<ul>
...
<h2 id="两阶段提交-two-phase-commit-2pc" tabindex="-1"><a class="header-anchor" href="#两阶段提交-two-phase-commit-2pc" aria-hidden="true">#</a> 两阶段提交 Two-Phase Commit (2PC)</h2>
<blockquote>
...
<p><img src="@source/面试宝典/06.微服务/img/b8624ace7c31f49016bde30abf444af0.png" alt="img"></p>
<ul>
<li>决定阶段 如果所有服务都回复 yes，协调器则向服务发送 commit 消息，接着服务告知事务完成或失败。如果任何服务提交失败， 协调器将启动额外的步骤以中止该事务。</li>
</ul>
<p><img src="@source/面试宝典/06.微服务/img/f29111544bc473085109d3d04788be44.png" alt="img"></p>
...
<h2 id="try-confirm-cancel-tcc" tabindex="-1"><a class="header-anchor" href="#try-confirm-cancel-tcc" aria-hidden="true">#</a> Try-Confirm/Cancel (TCC)</h2>
...
<p><img src="@source/面试宝典/06.微服务/img/b09bbf2e8d332c163934ce165eab883e.png" alt="img"></p>
<ul>
...
<p><img src="@source/面试宝典/06.微服务/img/1e14e4ad4804835734389a7a427ba9c3.png" alt="img"></p>
...
<h2 id="事件驱动的架构" tabindex="-1"><a class="header-anchor" href="#事件驱动的架构" aria-hidden="true">#</a> 事件驱动的架构</h2>
...
<p><img src="@source/面试宝典/06.微服务/img/a94dc9b0b1b2195f9cff27ea3056fd5d.png" alt="img"></p>
<p>一旦长活事务中的最后一个服务完成其子事务，它将通知它在事务中的前一个服务。接收到完成事件的服务将其在数据库中的记录状态设为完成。</p>
<p><img src="@source/面试宝典/06.微服务/img/204d8d1b2939d66cfb9752219ad70920.png" alt="img"></p>
...
<p><img src="@source/面试宝典/06.微服务/img/3f46ba9b45f867c33993cdb81871bfc9.png" alt="img"></p>
<p>Saga 则正好相反，所有这些耦合都在 saga 系统中，当在长活事务中添加新流程时，现有服务不需要任何改动。</p>
<h2 id="集中式与非集中式实现" tabindex="-1"><a class="header-anchor" href="#集中式与非集中式实现" aria-hidden="true">#</a> 集中式与非集中式实现</h2>
...
<p><img src="@source/面试宝典/06.微服务/img/1a7a9de881f2665697337a03fb1a5c6f.png" alt="img"></p>
