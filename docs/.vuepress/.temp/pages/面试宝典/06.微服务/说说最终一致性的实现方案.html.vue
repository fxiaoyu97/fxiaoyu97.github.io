<template><h1 id="说说最终一致性的实现方案" tabindex="-1"><a class="header-anchor" href="#说说最终一致性的实现方案" aria-hidden="true">#</a> 说说最终一致性的实现方案</h1>
<h2 id="问题的起源" tabindex="-1"><a class="header-anchor" href="#问题的起源" aria-hidden="true">#</a> 问题的起源</h2>
...
<h3 id="强一致" tabindex="-1"><a class="header-anchor" href="#强一致" aria-hidden="true">#</a> 强一致</h3>
<p>当更新操作完成之后，任何多个后续进程或者线程的访问都会返回最新的更新过的值。这种是对用户最友好的，就是用户上一次写什么，下一次就保证能读到什么。根据 CAP 理论，这种实现需要牺牲可用性。</p>
<h3 id="弱一致性" tabindex="-1"><a class="header-anchor" href="#弱一致性" aria-hidden="true">#</a> 弱一致性</h3>
<p>系统并不保证续进程或者线程的访问都会返回最新的更新过的值。系统在数据写入成功之后，不承诺立即可以读到最新写入的值，也不会具体的承诺多久之后可以读到。</p>
<h3 id="最终一致性" tabindex="-1"><a class="header-anchor" href="#最终一致性" aria-hidden="true">#</a> 最终一致性</h3>
...
<h2 id="_1-规避分布式事务——业务整合" tabindex="-1"><a class="header-anchor" href="#_1-规避分布式事务——业务整合" aria-hidden="true">#</a> 1. 规避分布式事务——业务整合</h2>
...
<h2 id="_2-经典方案-ebay-模式" tabindex="-1"><a class="header-anchor" href="#_2-经典方案-ebay-模式" aria-hidden="true">#</a> 2. 经典方案 - eBay 模式</h2>
...
<p>eBay 方式的主要思路如下。</p>
<h3 id="base-一种-acid-的替代方案" tabindex="-1"><a class="header-anchor" href="#base-一种-acid-的替代方案" aria-hidden="true">#</a> BASE：一种 ACID 的替代方案</h3>
...
<h3 id="base-basically-available-soft-state-eventually-consistent" tabindex="-1"><a class="header-anchor" href="#base-basically-available-soft-state-eventually-consistent" aria-hidden="true">#</a> BASE (basically available, soft state, eventually consistent)</h3>
...
<p><img src="@source/面试宝典/06.微服务/img/006kbv1Jgw1f31xaggg0bj30cq09mq3h.jpeg" alt="img"></p>
...
<p><img src="@source/面试宝典/06.微服务/img/006kbv1Jgw1f31xaq6ex2j30ct082wev.jpeg" alt="img"></p>
<p>系统的执行伪代码如下：</p>
...
For each message in queue
	...
	End if
End for
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br></div></div><p>基于以上方法，在第一阶段，通过本地的数据库的事务保障，增加了 transaction 表及消息队列 。</p>
...
<h2 id="_3-去哪儿网分布式事务方案" tabindex="-1"><a class="header-anchor" href="#_3-去哪儿网分布式事务方案" aria-hidden="true">#</a> 3. 去哪儿网分布式事务方案</h2>
...
<p>分布式事务有两种解决方式</p>
<h3 id="优先使用异步消息" tabindex="-1"><a class="header-anchor" href="#优先使用异步消息" aria-hidden="true">#</a> 优先使用异步消息</h3>
...
<h3 id="有的业务不适合异步消息的方式-事务的各个参与方都需要同步的得到结果" tabindex="-1"><a class="header-anchor" href="#有的业务不适合异步消息的方式-事务的各个参与方都需要同步的得到结果" aria-hidden="true">#</a> 有的业务不适合异步消息的方式，事务的各个参与方都需要同步的得到结果</h3>
...
<h2 id="_4-蘑菇街交易创建过程中的分布式一致性方案" tabindex="-1"><a class="header-anchor" href="#_4-蘑菇街交易创建过程中的分布式一致性方案" aria-hidden="true">#</a> 4. 蘑菇街交易创建过程中的分布式一致性方案</h2>
<h3 id="交易创建的一般性流程" tabindex="-1"><a class="header-anchor" href="#交易创建的一般性流程" aria-hidden="true">#</a> 交易创建的一般性流程</h3>
<p>我们把交易创建流程抽象出一系列可扩展的功能点，每个功能点都可以有多个实现（具体的实现之间有组合/互斥关系）。把各个功能点按照一定流程串起来，就完成了交易创建的过程。</p>
<p><img src="@source/面试宝典/06.微服务/img/006kbv1Jgw1f31xdryziuj30i008d0tu.jpeg" alt="img"></p>
<h3 id="面临的问题" tabindex="-1"><a class="header-anchor" href="#面临的问题" aria-hidden="true">#</a> 面临的问题</h3>
<p>每个功能点的实现都可能会依赖外部服务。那么如何保证各个服务之间的数据是一致的呢？比如锁定优惠券服务调用超时了，不能确定到底有没有锁券成功，该如何处理？再比如锁券成功了，但是扣减库存失败了，该如何处理？</p>
<h3 id="方案选型" tabindex="-1"><a class="header-anchor" href="#方案选型" aria-hidden="true">#</a> 方案选型</h3>
...
<p><img src="@source/面试宝典/06.微服务/img/006kbv1Jgw1f31xeajfqkj30680i2wez.jpeg" alt="img"></p>
<h2 id="_5-支付宝及蚂蚁金融云的分布式服务-dts-方案" tabindex="-1"><a class="header-anchor" href="#_5-支付宝及蚂蚁金融云的分布式服务-dts-方案" aria-hidden="true">#</a> 5. 支付宝及蚂蚁金融云的分布式服务 DTS 方案</h2>
<p>业界常用的还有支付宝的一种 xts 方案，由支付宝在 2PC 的基础上改进而来。主要思路如下，大部分信息引用自官方网站。</p>
<h3 id="分布式事务服务简介" tabindex="-1"><a class="header-anchor" href="#分布式事务服务简介" aria-hidden="true">#</a> 分布式事务服务简介</h3>
...
<h3 id="核心特性" tabindex="-1"><a class="header-anchor" href="#核心特性" aria-hidden="true">#</a> 核心特性</h3>
...
<p>以下是分布式事务框架的流程图</p>
<p><img src="@source/面试宝典/06.微服务/img/006kbv1Jgw1f31xfuizhpj30a70b7q3x.jpeg" alt="img"></p>
...
<h3 id="与-2pc-协议比较" tabindex="-1"><a class="header-anchor" href="#与-2pc-协议比较" aria-hidden="true">#</a> 与 2PC 协议比较</h3>
<ul>
<li>没有单独的 Prepare 阶段，降低协议成本</li>
<li>系统故障容忍度高，恢复简单</li>
</ul>
<h2 id="_6-农信网数据一致性方案" tabindex="-1"><a class="header-anchor" href="#_6-农信网数据一致性方案" aria-hidden="true">#</a> 6. 农信网数据一致性方案</h2>
<h3 id="电商业务" tabindex="-1"><a class="header-anchor" href="#电商业务" aria-hidden="true">#</a> 电商业务</h3>
...
<p><img src="@source/面试宝典/06.微服务/img/006kbv1Jgw1f31xgmb4wrj30hl09rgmn.jpeg" alt="img"></p>
<h3 id="用户信息变更" tabindex="-1"><a class="header-anchor" href="#用户信息变更" aria-hidden="true">#</a> 用户信息变更</h3>
...
<p><img src="@source/面试宝典/06.微服务/img/006kbv1Jgw1f31xhl94fyj30hu08qt9j.jpeg" alt="img"></p>
